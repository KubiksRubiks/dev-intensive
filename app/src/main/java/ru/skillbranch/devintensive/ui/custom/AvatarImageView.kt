...
class AvatarImageView @JvmOverloads constructor(
    ...
    init {
        ...
        borderWidthDp = Utils.convertPxToDp(context, borderWidth)
    ...
    //@Dimension(unit = DP)
    fun getBorderWidth(@Dimension(unit = DP) dp: Int) {
    ...
    private fun setup() {
        ...
        val borderWidth = Utils.convertDpToPx(context, borderWidthDp.toFloat())
